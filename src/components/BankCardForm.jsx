      ...
      <div className="currency_block">
        <div className="first_currency_wrap">
          <input
            type="number"
            className={`${
              errors.first_currency ? "first_currency error" : "first_currency"
            }`}
      ...
      <div className="single_card">
        <div className="card-item card_background">
          ...
          <div className="expiry_form">
            ...
            {errors.expiry_date && (
              <span style={{ color: "red" }}>Expiry date is required</span>
            )}
          </div>
        ...
        <div className="cvv_block card-item">
          ...
          <div className="cvv_input_wrap">
            ...
            />
            <span className="info_cvv">три цифры с обратной стороны карты</span>
            {errors.cvv && (
      ...
      <div className="terms_block">
        <div className="terms_check">
          ...
          <div className="terms">
            ...
            {errors.agree && <span style={{ color: "red" }}>Mark please</span>}
          </div>
        </div>
      </div>
